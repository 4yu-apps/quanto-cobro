...
abstract final class AppColorSchemes {
  static const ColorScheme dark = ColorScheme(
    ...
    // Rampa "Cofre de Aço": charcoal quase-neutro (croma esmagado de ~0.02 pra
    // ~0.006, um sussurro de verde só pra não ser cinza-sistema). Fundo neutro
    // faz o esmeralda #57E5A9 BRILHAR mais — o verde só parecia "sujo/antigo"
    // porque o fundo também era verde. Poços levantados um triz (menos "escuro").
    surface: Color(0xFF101312),
    onSurface: Color(0xFFE4E9E7),
    onSurfaceVariant: Color(0xFFACB4B1),
    surfaceContainerLowest: Color(0xFF0A0C0B),
    surfaceContainerLow: Color(0xFF171A19),
    surfaceContainer: Color(0xFF1E2120),
    surfaceContainerHigh: Color(0xFF272B29),
    surfaceContainerHighest: Color(0xFF303532),
    outline: Color(0xFF777F7C),
    outlineVariant: Color(0xFF363A38),
    inverseSurface: Color(0xFFE4E9E7),
    onInverseSurface: Color(0xFF20231F),
